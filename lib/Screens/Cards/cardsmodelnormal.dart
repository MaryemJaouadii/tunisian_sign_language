...
class CardsModelNormal extends StatefulWidget {
  final model data;

  CardsModelNormal(this.data);

  @override
  State<CardsModelNormal> createState() => _CardsModelNormalState();
}

class _CardsModelNormalState extends State<CardsModelNormal> {
  @override
                ...
                itemBuilder: (BuildContext context, int index) {
                  return new GestureDetector(
                    child: Padding(
                      ...
                      child: FlipCard(
                        front: MyApp.lightModeValue? Container(
                          child: Card(
